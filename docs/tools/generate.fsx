...
let githubLink = "http://github.com/bomret/NCaches"

// Specify more information about your project
let info =
  [ "project-name", "NCaches"
    "project-author", "Stefan Reichel"
    "project-summary", "Provides several abstractions for caching in code."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/NCaches" ]
